      ...
      <nav className="border-b border-border bg-card/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <img src="/lovable-uploads/5b3ece4f-29f4-4c15-8b21-212ced34d403.png" alt="Sponsa" className="w-10 h-10" />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="bg-gradient-card border-0 shadow-card hover:shadow-glow transition-all duration-300">
              <CardHeader>
                ...
                <CardDescription>
                  Track earnings and withdraw to your UPI ID whenever you want
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-gradient-card border-0 shadow-card hover:shadow-glow transition-all duration-300">
              <CardHeader>
                ...
                <CardDescription>
                  Drop-in browser source overlay for your streaming setup
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-gradient-card border-0 shadow-card hover:shadow-glow transition-all duration-300">
              <CardHeader>
                ...
                <CardDescription>
                  Permanent links, easy sharing, and viewer-friendly tip flow
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
      ...
      <section className="py-20 bg-gradient-hero text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Ready to Maximize Your Creator Income?
          </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-muted-foreground">
              © 2024 Sponsa. Built for creators, by creators.
            </div>
          </div>
        </div>
      </footer>
